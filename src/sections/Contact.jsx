...
function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        import.meta.env.VITE_EMAILJS_SERVICE_ID,   // stored in .env
      ...
      <div className='w-full max-w-7xl p-5 rounded-4xl bg-white/15 backdrop-blur-md border border-white/15 shadow-lg'>
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-white'>
          ...
          >
            ...
            >
              <a href="https://www.linkedin.com/in/markabaño" target='_blank' rel='noopener noreferrer'>
            ...
            <motion.div
              ...
              className='flex items-center h-20 w-full px-5 bg-white/15 border border-white/15 backdrop-blur-md shadow-lg rounded-2xl'
            >
              <a href="https://github.com/markabano" target='_blank' rel='noopener noreferrer'>
                <div className='flex items-center gap-3'>
                  <SiGithub />
            ...
            <motion.div
              ...
              className='flex items-center h-20 w-full px-5 bg-white/15 border border-white/15 backdrop-blur-md shadow-lg rounded-2xl'
            >
              <a href="mailto:markabanomain@gmail.com" target='_blank' rel='noopener noreferrer'>
                <div className='flex items-center gap-3'>
                  <SiGmail />
