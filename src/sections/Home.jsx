      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 items-center max-w-7xl mt-20 mx-2 sm:mx-4 p-5 sm:p-8 rounded-4xl bg-white/15 backdrop-blur-md border border-white/15 shadow-lg">
        ...
        >
          ...
          <p className="text-sm md:text-md lg:text-lg text-gray-300 leading-relaxed mt-4">
            Hi, I’m Mark Joseph Abaño, a web developer who loves building
            modern, efficient, and user-friendly web applications. I enjoy
            turning ideas into functional digital experiences using technologies
            like React, Tailwind CSS, Node.js, and Express. My goal is to create
            solutions that are not only visually appealing but also impactful
            and maintainable.
          </p>
        </motion.div>
